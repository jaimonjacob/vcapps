...
xhr.open('GET', 'https://watershedlrs.com/api/organizations/11951/lrs/statements');
xhr.setRequestHeader("x-experience-api-version", "1.0.3");
xhr.setRequestHeader("authorization", "Basic NTlhMWRiZjBmOWQ5YjQ6ODUwMGE1NWMzOGQ4YTA=");
xhr.send(); 